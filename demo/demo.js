...
function initPlayers() {
    ...
    //         url: 'http://192.168.0.101:7001/videoInfo/analyzeM3u8File/1827881723366150145/1827882988976345090?token=FBC7DD0C202F0508330162E34AAF6582',
    //         type: 'customHls',
    //         customType: {
    ...
    //     hotkey: true,
    //     logo: {
    //         url: 'https://i.loli.net/2019/06/06/5cf8c5d94521136430.png',
    //         opacity: 0.5,
    //         move: true,
    //     },
    //     volume: 0,
    ...
    window.dp3 = new DPlayer({
        ...
        video: {
            quality: [
                {
                    name: 'HD',
                    url: 'http://192.168.0.101:7001/videoInfo/clientGetM3u8.m3u8?videoInfoId=1827964297555935234&videoPlaySourceId=1827964456083865602',
                    customType: {
                        customHls: function (video, player) {
                            const hls = new Hls();
                            hls.loadSource(video.src);
                ...
                {
                    name: 'SD',
                    url: 'http://192.168.0.101:7001/videoInfo/clientGetM3u8.m3u8?videoInfoId=1827964297555935234&videoPlaySourceId=1827964518193119233',
                    customType: {
                        customHls: function (video, player) {
                            const hls = new Hls();
                            hls.loadSource(video.src);
